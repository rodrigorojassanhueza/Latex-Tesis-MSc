...
Para la subducción se definieron dos escenarios representativos, los que se analizaron por separado, uno interplaca ($M_w=9.3$) y otro intraplaca ($M_w=8.0$). En el caso intraplaca se consideraron tres orientaciones en planta para capturar la sensibilidad geométrica asociada a la dirección del plano de ruptura: caso base (0°) y rotaciones de 20° y 40° en sentido horario respecto al norte, rotando el plano de ruptura a partir de la superficie propuesta por Hayes (2018). En la Figura~\ref{fig:meto_dsha_geometrias} se ilustran las geometrías en planta de los escenarios deterministas considerados para la FSR y para la subducción (interplaca e intraplaca).
