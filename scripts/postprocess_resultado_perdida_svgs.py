...
DEFAULT_PROJECT_ROOT = REPO.parent
RESULTS = Path(
    os.environ.get(
        "TESIS_RESULTS_DIR",
        DEFAULT_PROJECT_ROOT / "Modelos_v2025" / "resultados_finales",
    )
)
RISK = RESULTS / "risk_event_based"
MAPS = RESULTS / "mapas_AAL_AALR_duckdb_FSR_vs_noFSR"
DEST = REPO / "assets" / "figures" / "thesis" / "resultados_perdida"
WORK = REPO / "build" / "graph_generation_work" / "processed_svgs"
