...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{assets/figures/thesis/metodologia/escenarios_simulados.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{assets/figures/thesis/metodologia/mapa_sitios_interes.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{assets/figures/thesis/metodologia/distribución_materialidades_costo.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.30\textheight]{assets/figures/thesis/metodologia/vulnerabilidad_cabrera_paper.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.30\textheight]{assets/figures/thesis/metodologia/vulnerabilidad_hazus_paper.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.30\textheight]{assets/figures/thesis/metodologia/vulnerabilidad_junemann_paper.png}
...
\begin{figure}[htbp]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/paper_Rcut_vs_Mw_interplaca_PGA.pdf}
		\subcaption{Interplaca}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/paper_Rcut_vs_Mw_intraplaca_PGA.pdf}
...
\begin{figure}[htbp]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/paper_Rcut_vs_Mw_interplaca_SA1p0s.pdf}
		\subcaption{Interplaca}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/paper_Rcut_vs_Mw_intraplaca_SA1p0s.pdf}
		\subcaption{Intraplaca}
	\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/QA_A_r01_m580_mapa_sitios.png}
		\subcaption{Mapa de sitios}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/QA_A_r01_m580_pearson_6x6.png}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/QA_A_r01_m580_map_vs30.png}
		\subcaption{Mapa $V_{S30}$}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/QA_A_r01_m580_map_z1pt0.png}
		\subcaption{Mapa $Z_{1.0}$}
	\end{minipage}
	\par\smallskip
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/QA_A_r01_m580_hist_frac_vs30.png}
		\subcaption{Distribución $V_{S30}$}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/QA_A_r01_m580_hist_frac_z1pt0.png}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/Tu_uaxis_sq_v2_thr0p20.pdf}
		\subcaption{PGA = 0.2g}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/Tu_uaxis_sq_v2_thr0p40.pdf}
		\subcaption{PGA = 0.4g}
	\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/comparacion_02.png}
		\subcaption{PGA = 0.2g}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/comparacion_04.png}
		\subcaption{PGA = 0.4g}
	\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.95\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/PGA_Panels_VertLines.png}
		\subcaption{PGA}
	\end{minipage}
	\par\smallskip
	\begin{minipage}{0.95\textwidth}
		\centering
		\includegraphics[width=\textwidth]{assets/figures/thesis/metodologia/SA(1.0)_Panels_VertLines.png}
		\subcaption{SA(1.0)}
	\end{minipage}
